...
class CreatePlist
{
    ...
    function __destruct()
    {
 	...
 	function create($arr)
    { 
		$sql = "SELECT * FROM issues where active = 1 ORDER BY date_end ASC, title ASC, date_start ASC";
...
<array>';
    ...
    <dict>
		...
		<key>Subtitle</key>
		<string>' . utf8_decode ($arr[$i]['subtitle']) . '</string>
		<key>Title</key>
		<string>' . utf8_decode ($arr[$i]['title']) . '</string>
	</dict>';
		}
/* 	<dict>
		<key>FileName</key>
